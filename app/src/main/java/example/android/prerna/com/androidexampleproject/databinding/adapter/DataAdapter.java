package example.android.prerna.com.androidexampleproject.databinding.adapter;
...
import example.android.prerna.com.androidexampleproject.databinding.ItemDataBinding;
import example.android.prerna.com.androidexampleproject.databinding.model.DataModel;
import example.android.prerna.com.androidexampleproject.databinding.viewModel.DataItemViewModel;
...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.DataViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DataViewHolder dataViewHolder, int position) {
        ...
        dataViewHolder.setViewModel(new DataItemViewModel(model));
    }
